...
func TestMSSQLTypeMapping(t *testing.T) {
	tests := []struct {
		...
		{"DATETIME2(6)", 0, 0, false, &arrow.TimestampType{Unit: arrow.Microsecond, TimeZone: ""}},
		{"DATETIME2(7)", 0, 0, false, arrow.BinaryTypes.String},
		{"DATETIMEOFFSET(7)", 0, 0, false, arrow.BinaryTypes.String},
		{"TIME(7)", 0, 0, false, arrow.BinaryTypes.String},
